      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="card p-6 flex flex-col items-center text-center gap-3">
          ...
          <div className="flex gap-2 flex-wrap justify-center">
            ...
            <span className="badge badge-secondary">Year {profile?.year}</span>
            <span className="badge badge-secondary">Sec {profile?.section}</span>
          </div>
          ...
          <form onSubmit={handleSave} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="tel" name="phone" className="input" defaultValue={profile?.phone ?? ""} placeholder="+91 00000 00000" />
              </div>
              <div>
                <label className="label">Address</label>
                <input name="address" className="input" defaultValue={profile?.address ?? ""} placeholder="Your address" />
              </div>
              <div>
                <label className="label">LinkedIn URL</label>
                <input name="linkedin_url" className="input" defaultValue={profile?.linkedin_url ?? ""} placeholder="https://linkedin.com/in/..." />
              </div>
              <div>
                <label className="label">GitHub URL</label>
                <input name="github_url" className="input" defaultValue={profile?.github_url ?? ""} placeholder="https://github.com/..." />
              </div>
            </div>
